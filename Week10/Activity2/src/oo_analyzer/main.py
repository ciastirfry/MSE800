...
from .analyzers import LengthAnalyzer, UppercaseAnalyzer, DigitAnalyzer, SpecialCharAnalyzer

def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="OO Analyzer: extended metrics.")
...
def main() -> None:
    ...
    import json as _j
    print(_j.dumps(metrics, indent=2))
